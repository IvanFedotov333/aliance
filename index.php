  ...
  <body class="front-page">
    ...
    <nav class="navbar">
      ...
      <ul class="header-nav">
        ...
        <li class="header-nav-item">
          <a href="/trademarks.html" class="header-nav-link">Собственные торговые марки</a>
        </li>
        <li class="header-nav-item">
      ...
      <div class="container">
        ...
        <div class="swiper features-slider">
          ...
          <ul class="swiper-wrapper header-features">
            ...
            <li class="swiper-slide header-features-item">
              <svg width="30" height="30">
                <use href="img/sprite.svg#Cargo"></use>
              </svg>
              <p class="header-features-text">
    ...
    <section class="section production">
      <div class="container">
        ...
        <div class="cards">
          <a href="/carchem.html" class="card">
            ...
            <img src="img/1.png" alt="Автомобильная химия" class="card-img" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
            ...
            <img src="img/2.png" alt="Бытовая химия" class="card-img" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
          ...
          <a href="#" class="card">
            ...
            <img src="img/3.png" alt="Пищевые аэрозоли" class="card-img" />
          </a>
          <a href="#" class="card">
            <div class="card-content">
          ...
          <a href="#" class="card">
            ...
            <img src="img/2.png" alt="Краски аэрозольные" class="card-img" />
          </a>
        </div>
        <!-- /.cards -->
      </div>
      ...
      <div class="container">
        ...
        <div class="swiper blog-slider">
          ...
          <div class="swiper-wrapper">
            <!-- Slides -->
            <a href="/methods.html" class="swiper-slide blog-card"
              ><img
        ...
        <div class="cta-form-wrapper container">
          <form action="#" class="cta-form">
            ...
            <div class="input-group-wrapper">
              ...
              <!-- /.input-group -->
              <div class="input-group">
                <input id="user-tel" type="tel" class="input" placeholder=" " />
