<section class="section blog">
  <div class="container">
    ...
    <nav class="blog-pagination" aria-label="Пагинация блога">
      <ul class="blog-bagination-list">
        <li class="blog-pagination-item">
          <a href="#" class="blog-pagination-link pagination-link-active" aria-current="page">1</a>
        </li>
        <li class="blog-pagination-item">
          <a href="#" class="blog-pagination-link">2</a>
        </li>
        <li class="blog-pagination-item">
          <a href="#" class="blog-pagination-link">3</a>
        </li>
        <li class="blog-pagination-item">
          <a href="#" class="blog-pagination-link">4</a>
        </li>
        <li class="blog-pagination-item">
          <a href="#" class="blog-pagination-link">5</a>
        </li>
      </ul>
    </nav>
  </div>
