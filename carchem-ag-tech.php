  ...
  <body>
    <div class="mobile-menu">
      <ul class="mobile-menu-nav">
        ...
        <li class="mobile-menu-item">
          ...
          <ul class="mobile-submenu">
            <li class="mobile-submenu-item">
              <a href="/carchem.html" class="mobile-submenu-link"
        ...
        <li class="mobile-menu-item">
          ...
          <ul class="mobile-submenu">
            <li class="mobile-submenu-item">
              <a href="/carchem-ag-tech.html" class="mobile-submenu-link"
                >Автохимия AG-Tech</a
              >
            </li>
            <li class="mobile-submenu-item">
    ...
    <nav class="navbar navbar-light">
      ...
      <ul class="header-nav">
        ...
        <li class="header-nav-item">
          <a href="/trademarks.html" class="header-nav-link"
    ...
    <header class="header-carchem">
      <div class="bg-gray">
        <div class="container">
          ...
          <img src="img/avto-him.png" alt="avto-him image" class="autohim-img">
        </nav>
        </div>
      </div>
    </header>
